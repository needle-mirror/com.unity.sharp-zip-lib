...
namespace Unity.SharpZipLib.Tests.GZip
{
    ...
    internal class GZipTestSuite
    {
        ...
        public void TestGZip()
        {
            ...
            var buf = Unity.SharpZipLib.Tests.TestSupport.Utils.GetDummyBytes(size: 100000);
        ...
        public void TrailingGarbage()
        {
            ...
            var buf = Unity.SharpZipLib.Tests.TestSupport.Utils.GetDummyBytes(size: 100000, seed: 3);
            // compress input buffer
            outStream.Write(buf, 0, buf.Length);
            outStream.Flush();
            outStream.Finish();
            // generate random trailing garbage and add to the compressed stream
            Unity.SharpZipLib.Tests.TestSupport.Utils.WriteDummyData(ms, size: 4096, seed: 4);
        ...
        public void FlushToUnderlyingStream()
        {
            var ms = new MemoryStream();
            var outStream = new GZipOutputStream(ms);
            byte[] buf = Unity.SharpZipLib.Tests.TestSupport.Utils.GetDummyBytes(size: 100000);
            outStream.Write(buf, 0, buf.Length);
        ...
        public void SmallBufferDecompression([Values(0, 1, 3)] int seed)
        {
            ...
            var inputBuffer = Unity.SharpZipLib.Tests.TestSupport.Utils.GetDummyBytes(outputBufferSize * 4, seed);
        ...
        public void ShouldGracefullyHandleReadingANonReadableStream()
        {
            ...
            using (var gzos = new GZipOutputStream(ms))
            {
                ...
                Unity.SharpZipLib.Tests.TestSupport.Utils.WriteDummyData(gzos, size: 100000);
            }
            ms.Seek(0, SeekOrigin.Begin);
