...
namespace Unity.SharpZipLib.Tests.TestSupport
{
    ...
    /// </summary>
    internal class TrackedMemoryStream : MemoryStream
    {
        /// <summary>
    ...
    /// that tracks closing and disposing
    /// </summary>
    internal class TrackedFileStream : FileStream
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedMemoryStream"/> class.
        /// </summary>
    ...
    /// </summary>
    internal class MemoryStreamWithoutSeek : TrackedMemoryStream
    {
        /// <summary>
    ...
    /// </remarks>
    internal class MemoryStreamWithoutSync : Stream
    {
